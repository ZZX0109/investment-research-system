...
def build_cn_equity_core(
    ...
    for symbol, values in by_symbol.items():
        ...
        ranked.append(ResearchCohortMember(
            ...
            observed_sessions=len(ordered), coverage_ratio=min(1.0, coverage),
...
def build_cn_etf_benchmark(bars: list[PreparedPriceBar], *, as_of: date) -> ResearchCohortManifest:
    ...
    members = [
        ResearchCohortMember(
            ...
            observed_sessions=len(values), coverage_ratio=1.0,
    ...
    return ResearchCohortManifest(
        cohort="cn_etf_benchmark", as_of=as_of, members=members,
